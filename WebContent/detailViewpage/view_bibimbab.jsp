...
<body>
 <!-- 헤더 -->
  ...
  <jsp:include page ="../header2.jsp" flush="true"/>
			...
			<div class="inner">
				...
				<div class="inner__right">
					...
					<div class="freeDelivery">
						이벤트 &nbsp;| &nbsp; 맛키트 회원이라면, <span class="green-color">무료배송!</span>
					</div>
					...
					<div class="price_box_wrap">
						...
						<div class="price_box">
							<span class="product_price">상품가격</span> <span id="price"
								class="product_price1 "> 13000</span><span>원</span>
						</div>
						...
						<div class="tot_price">
							<span class="tot_price1">총 주문금액</span> <span id="totalPrice"
								class="tot_price2">13000</span><span>원</span>
						</div>
	...
	<!-- 상품안내&리뷰&배송안내 tab -->
	<div class="infoTab">
		<label class="prod_info"> <input type="radio" name="showType"
			class="prod_info1" id="showTypeContent" checked=""> <span
			class="prod_info2 btn-show" onclick="animateScroll('#detail-area')">상품설명</span>
		</label> <label class="prod_review"> <input type="radio"
			name="showType" class="prod_review1"> <span
			class="prod_review2 btn-show" onclick="animateScroll('#review-area')">리뷰</span>
		</label> <label class="delv_info"> <input type="radio" name="showType"
			class="delv_info1"> <span class="delv_info2 btn-show"
			onclick="animateScroll('#delivery-area')">배송안내</span>
		</label>
	</div>


	<!-- 상품 상세 설명 tab -->
	<div id="detail-area" class="info_area"
		style="text-align: center; font-size: 36px; font-weight: 800px;">
	...
	<div id="delivery-area" class="delv_area" style="text-align: left">
		...
		<div class="delv_area2">
			...
			<p>
				[공통] 맛키트 회원 모두 무료배송입니다<br> [유의사항] 교환 및 환불의 경우, 택배비가 발생할 수 있습니다.
			</p>

			<span class="delv_area4">1-2. 일반배송 (택배배송)</span>
			<p>
				[배송일] 오전10시까지 결제가 완료된 상품은 당일발송을 원칙으로 합니다.<br> [배송방법] 우체국 택배를
				통해서 배송되며, 송장 번호는 주문내역에서 개별적으로 확인 가능합니다.<br> [배송지역] 전국 모든 지역 배송
				가능합니다. (제주도 및 도서 산간 지역은 1~2일 늦어질 수 있습니다.)<br> [배송시간] 택배로 배송 당일
				정확한 배송 시간 안내는 어려운 점 양해 부탁드립니다.<br>
			...
			<p>
				...
				[발송 준비] 단계에서는 주문 내역 변경 및 주문 취소가 불가합니다.<br> [배송 완료] 배송 이후에는 상황에
				따라 교환 및 환불이 불가할 수 있습니다.<br> [기타] 무통장 결제의 환불은 주문취소요청이 확인된 날짜
				기준으로 다음날(휴일 제외)에 일괄적으로 이루어집니다.
			</p>
		</div>
	</div>
